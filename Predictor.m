function [mean_x,mean_y]= Predictor(ImUR,ImUL,ImDL,ImDR,Desired)
%% Reading Images
...
Board=imread('untitled2.png'); 
%% Finding the Iris in All Pictures
...
figure;
%% Computing the Average of Coordinates
...
%% Computing and Predicting the Place Where the User was watching
